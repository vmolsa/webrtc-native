...
export enum RTCIceGatherPolicy {
  /** 
...
export enum RTCIceCredentialType {
  /** 
...
export type RTCStatsReport = { [key: string]: RTCStats };
...
export type RTCIceGatherCandidate = RTCIceCandidate | RTCIceCandidateComplete
 ...
 * algorithm specified in [RFC3447] and using the SHA hash functions defined in this specification.
 * 
 * Other specifications may specify the use of additional hash algorithms with RSASSA-PKCS1-v1_5. 
 * Such specifications must define the digest operations for the additional hash algorithms and key import steps 
 * and key export steps for RSASSA-PKCS1-v1_5.
 */
...
export class RTCCertificate {
  ...
  private _fingerprint: RTCDtlsFingerprint;
  private _algorithm: AlgorithmIdentifier;
  ...
  public get fingerprint(): RTCDtlsFingerprint {
  ...
  public getAlgorithm(): AlgorithmIdentifier {
...
export class RTCDtlsTransport extends Stream.Transform implements RTCStatsProvider {
  /*
  ...
  private _transport: RTCIceTransport;
  private _state: RTCDtlsTransportState;

  /**
   * The associated RTCIceTransport instance.
   */

  public get transport(): RTCIceTransport {
  ...
  public getCertificates(): RTCCertificate[] {
    return undefined;
  }
  ...
  public getLocalParameters(): RTCDtlsParameters {
    return undefined;
  }
  ...
  public getRemoteParameters(): RTCDtlsParameters {
    return undefined;
  }
  ...
  public getRemoteCertificates(): RTCCertificate[] {
    return undefined;
  }
  ...
  public start(remoteParameters: RTCDtlsParameters) {
...
export class RTCRtpListener {
  ...
  private _transport: RTCDtlsTransport;
...
export type NodeStream = Stream.Duplex | 
                         Stream.Readable | 
                         Stream.Writable | 
                         Stream.Transform | 
                         Stream.PassThrough;
...
export class RTCRtpSender extends Stream.Duplex implements RTCStatsProvider {
  /*
  ...
  private _track: NodeStream;
  private _transport: RTCDtlsTransport;
  private _rtcpTransport: RTCDtlsTransport;
  ...
  public get rtcpTransport(): RTCDtlsTransport {
  ...
  public setTransport(transport: RTCDtlsTransport, rtcpTransport: RTCDtlsTransport): void {
  ...
  public setTrack(trackOrKind?: NodeStream): Promise<void> {
    return undefined;
  }
  ...
  public replaceTrack(trackOrKind?: NodeStream): Promise<void> {
    return undefined;
  }
  ...
  public send(parameters: RTCRtpParameters): Promise<void> {
    return undefined;
  }
...
export class RTCRtpReceiver extends Stream.Duplex implements RTCStatsProvider {
  /**
  ...
  public receive(parameters: RTCRtpParameters): Promise<void> {
    return undefined;
  }
  ...
  public getContributingSources(): RTCRtpContributingSource[] {
    return undefined;
  }
  ...
  public getSynchronizationSources(): RTCRtpSynchronizationSource[] {
    return undefined;
  }
...
export class RTCDataChannel extends Stream.Duplex {
  ...
  private _state: RTCDataChannelState;
  private _transport: RTCDataTransport;
  ...
  public get transport(): RTCDataTransport {
    return this._transport;
  }
  ...
  public getParameters(): RTCDataChannelParameters {
    return undefined;
  }
  ...
  public send(data: string | ArrayBuffer | ArrayBufferView | Buffer) {
...
export class RTCSctpTransport extends Stream.Transform implements RTCDataTransport {
  /*
  ...
  private _transport: RTCDtlsTransport;
  private _state: RTCSctpTransportState;
  ...
  public get state(): RTCSctpTransportState {
    return this._state;
  }  
  ...
  public static getCapabilities(): RTCSctpCapabilities {
    return undefined;
  }
  ...
  public start(remoteCaps: RTCSctpCapabilities, remotePort?: number): void {
